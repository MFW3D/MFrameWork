...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='Manager_Client.proto',
  package='PManager_Client',
  syntax='proto3',
  serialized_pb=_b('\n\x14Manager_Client.proto\x12\x0fPManager_Client\x1a\x11\x43ommon_Base.proto\x1a\rDB_Base.proto\"\n\n\x08Point_Fbb\x06proto3')
  ,
...
_POINT_FB = _descriptor.Descriptor(
  name='Point_Fb',
  full_name='PManager_Client.Point_Fb',
  filename=None,
  file=DESCRIPTOR,
