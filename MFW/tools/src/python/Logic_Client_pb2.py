...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='Logic_Client.proto',
  package='PLogic_Client',
  syntax='proto3',
  serialized_pb=_b('\n\x12Logic_Client.proto\x12\rPLogic_Client\x1a\x11\x43ommon_Base.proto\x1a\rDB_Base.proto\"\n\n\x08Point_Fbb\x06proto3')
  ,
...
_POINT_FB = _descriptor.Descriptor(
  name='Point_Fb',
  full_name='PLogic_Client.Point_Fb',
  filename=None,
  file=DESCRIPTOR,
